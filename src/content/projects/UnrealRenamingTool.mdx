...
During my studies, I worked for projects at [Styles Studio SàRL](https://styles-studio.com/). During that time I sometimes had to integrate objects from divers origins into Unreal projects. Since the naming conventions weren't strictly established I often had to rename objects and folder.
