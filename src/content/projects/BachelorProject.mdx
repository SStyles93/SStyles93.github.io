...
description: "Bachelor project about 3D Fur generation going in depth in the process form naïve implementation to an optimized version"
heroImage: "/src/assets/images/bachelorproject/Picture58.png"
order: 0
pinned: true
...
This project details it in depth.

you can access the full paper in a PDF version below

<div class="flex justify-center">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-20">
        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
    </svg>
        <Button href="/pdf/Bachelor_Thesis.pdf">Open PDF</Button> 
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-20">
...
<MdImage src={images.bachelorproject_Picture1_png} alt="" class="w-full"/>_Figure 1 - Hair and fur Render Time on characters. (Edgardlop, 2013)_
...
<MdImage src={images.bachelorproject_Picture2_png} alt="" class="w-full"/>_2 - Fur generation example from Real-Time Fur over Arbitrary Surfaces. (Lengyel et al., 2001)_  
...
<MdImage src={images.bachelorproject_Picture3_png} alt="" class="w-full"/>_3 - 80.lv student hair for games from Greg Mourino. (80.lv, 2018) & Detective Pikachu film caption. (Machkovech, 2019)_  
...
<MdImage src={images.bachelorproject_Picture4_png} alt="" class="w-full"/>_4 - Realistic Dog Portrait: Experimenting with Real-Time Fur. (80.lv, 2021)_  
...
<MdImage src={images.bachelorproject_Picture5_png} alt="" class="w-full"/>_5 - Unity download archive. (Unity Technologies, n.d.-b)_  
...
<MdImage src={images.bachelorproject_Picture6_png} alt="" class="w-full"/>_6 - Unity Hub 3.7.0 Installs screenshot, (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture7_png} alt="" class="w-full"/>_7 – A shell-based fur strand example. (GiM, n.d.)_  
...
<MdImage src={images.bachelorproject_Picture8_png} alt="" class="w-full"/>_8 - Visualisation of shells on low-poly mesh. (GiM, n.d.)_  
...
<MdImage src={images.bachelorproject_Picture9_png} alt="" class="w-full"/>_9 - Example of coloured Shell-based fur. (Afanasev, 2018)_  
 
#### 2.2.2 Fin
...
<MdImage src={images.bachelorproject_Picture10_png} alt="" class="w-full"/>_10 - Illustration of fin extrusion. (Lengyel et al., 2001)_  
...
<MdImage src={images.bachelorproject_Picture11_png} alt="" class="w-full"/>_11 - Fin generation example and illustration. (Tariq, 2007)_  
 
#### 2.2.3 Polygon
...
<MdImage src={images.bachelorproject_Picture12_png} alt="" class="w-full"/>_12 - Polygonal hair example from The Last of Us. (Imgur, n.d.)_  
...
<MdImage src={images.bachelorproject_Picture13_png} alt="" class="w-full"/>_13 - Vertex shader with adaptive mesh according to LOD. (GDCVault, n.d.)_  
...
<MdImage src={images.bachelorproject_Picture14_png} alt="" class="w-full"/>_14 - Shadow of Colossus in game caption of the player looking at a Colossus. (Froyok, n.d.)_  
...
<MdImage src={images.bachelorproject_Picture15_png} alt="" class="w-full"/>_15 - Viva Piñata in Game Caption. (NBC News, 2006)_  
...
<MdImage src={images.bachelorproject_Picture16_png} alt="" class="w-full"/>_16 - Dark Souls III Wolf boss (Sif). (Creswell, 2021)_  
...
<MdImage src={images.bachelorproject_Picture17_png} alt="" class="w-full"/>_17 - Genshin impact illustration. (For The Win, 2022)_  
...
<MdImage src={images.bachelorproject_Picture18_png} alt="" class="w-full"/>_18 - In-game caption of Genshin Impact. (X (formerly Twitter), 2024)_  
...
<MdImage src={images.bachelorproject_Picture19_png} alt="" class="w-full"/>_19 - Genshin impact caption with coloured rectangle highlighting specific elements. (X (formerly Twitter), 2024)_  
...
<MdImage src={images.bachelorproject_Picture20_png} alt="" class="w-full"/>_20 - Caption in Unity editor of the cloned github project from Hecomi showing shell, fin, and geometry shader from left to right. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture21_png} alt="" class="w-full"/>_21 - Caption in Unity editor of the cloned github project from Hecomi showing shell. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture22_png} alt="" class="w-full"/>_22 - Caption in Unity editor of the cloned github project from Hecomi showing shell material parameters . (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture23_png} alt="" class="w-full"/>_23 - Caption in Unity editor of the project from Hecomi showing measures taken. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture24_png} alt="" class="w-full"/>_24 - Capture of the Render Debugger from Unity. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture25_png} alt="" class="w-full"/>_25 - Unity editor caption of the Memory Profiler tool indicating the difference memory allocations. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture26_png} alt="" class="w-full"/>_26 - Unity editor Statistics tool. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture27_png} alt="" class="w-full"/>_27 - Unity Profiler (top) and Timeline (bottom). (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture28_png} alt="" class="w-full"/>_28 - Unity Rendering Debugger tool showing the Display Stats category. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture29_png} alt="" class="w-full"/>_29  - Unity editor caption of the Memory Profiler tool. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture30_png} alt="" class="w-full"/>_30 - Unity editor screenshot of the Frame Debugger tool. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture31_png} alt="" class="w-full"/>_31 - RenderDoc used on Hecomi's project. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture32_png} alt="" class="w-full"/>_32 - NVIDIA Nsight Graphics used on the initial approach project. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture33_png} alt="" class="w-full"/>_33 - Combination of screenshots resuming the process to activate GPUWatch on Samsung Galaxy A50. 
(Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture34_png} alt="" class="w-full"/>_34 - UnityHub screenshot of the Installs category showing the 2022.3.24f1 LTS version. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture35_png} alt="" class="w-full"/>_35 - Unity editor Package manager tool showing the installed packages. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture36_png} alt="" class="w-full"/>_36 - Visual Studio IDE Installer showing the packages category. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture37_png} alt="" class="w-full"/>_37 - Unity editor NaïveShell project exposing the Canvas prefab in the Hierarchy. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture38_png} alt="" class="w-full"/>_38 - Unity editor screenshots of two Inspectors exposing the SimpleShell script and HLSLGeom shader material parameters. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture39_png} alt="" class="w-full"/>_39 - Unity scene showing attempts at Shell and Fin shader merging. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture40_png} alt="" class="w-full"/>_40 - Unity editor screenshot showing the HLSLGeom1 scene with light information in the inspector. 
(Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture41_png} alt="" class="w-full"/>_41 - Unity editor screenshot showing the HLSL_ComplexScene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture42_png} alt="" class="w-full"/>_42 - Capture of the Unity Build Settings window. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture43_png} alt="" class="w-full"/>_43 - Unity editor screenshot of the Inspector window showing the relation between player input and HLSL shader. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture44_png} alt="" class="w-full"/>_44 - Unity editor screenshot showing the rigger horse from TruboSquid with the HLSL shader on it. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture45_png} alt="" class="w-full"/>_45 - Unity capture showing the Sphere object's inspector. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture46_png} alt="" class="w-full"/>_46 - Unity editor showing the mesh layering from the initial approach project. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture47_png} alt="" class="w-full"/>_47 - Capture of the SimpleShell.cs script in the Visual Studio IDE. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture48_png} alt="" class="w-full"/>_48 - Capture of Hugo Elias’ hashing function from the Shell.shader script in the Visual Studio IDE. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture49_png} alt="" class="w-full"/>_49 - Capture of the Vertex shader code from the Shell.shader script in the Visual Studio IDE. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture50_png} alt="" class="w-full"/>_50 - Capture of the fragment shader code from the Shell.shader script in the Visual Studio IDE. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture51_png} alt="" class="w-full"/>_51 - Capture of the initial approach scene in the Unity editor. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture52_png} alt="" class="w-full"/>_52 - Unity editor capture of the HLSLGeom shader's material showing parameters in the inspector window. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture53_png} alt="" class="w-full"/>_53 - Capture of the Geometry shader code from the Fur.hlsl script in the Visual Studio IDE. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture54_png} alt="" class="w-full"/>_54 - Unity editor capture of the HLSLGeom scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture55_png} alt="" class="w-full"/>_55 - Unity editor capture of the material parameters in the inspector window. (Styles, 2024)_  

The previous values for each channel are used as influence modifiers to reduce the impact of each texture if necessary.  
 
<MdImage src={images.bachelorproject_Picture56_png} alt="" class="w-full"/>_56 - Unity editor capture of the HLSL_ComplexObject scene showing the riggerd horse without colour (left) and with colour (right). (Styles, 2024)_  

This implementation allows complex meshes to be coloured according to the textures produced by an artist.  
 
<MdImage src={images.bachelorproject_Picture57_png} alt="" class="w-full"/>_57 - Unity editor inspector window capture showing the shell detail parameters. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture58_png} alt="" class="w-full"/>_58 - Unity editor capture of three shader variations showing the rigged horse with short (right), long (middle), and red tinted (left) fur. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture59_png} alt="" class="w-full"/>_59 - Unity editor inspector capture showing the Animator component. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture60_png} alt="" class="w-full"/>_60 - Unity editor Hierarchy capture showing the Canvas prefab hierarchy. (Styles, 2024)_  

The user input was dealt with the Unity input system and an EventSystem component (Figure 60).  
 
<MdImage src={images.bachelorproject_Picture61_png} alt="" class="w-full"/>_61 - Unity editor inspector window capture showing the EventSytem component. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture62_png} alt="" class="w-full"/>_62 - Unity editor capture of the Project Settings window showing the Active Input Handling parameter. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture63_png} alt="" class="w-full"/>_63 - Hecomi's project measurements, (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture64_png} alt="" class="w-full"/>_64 - Unity editor bottom left UI options showing the release (left) and debug (right) presets. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture65_png} alt="" class="w-full"/>_65 - Measurement of the Initial approach project. (Styles,  2024)_  
...
<MdImage src={images.bachelorproject_Picture66_png} alt="" class="w-full"/>_66 - Unity editor capture showing the measurement of the NaïveShell scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture67_png} alt="" class="w-full"/>_67 - Unity editor capture showing the Memory Profiler on the NaïveShell scene. (Styles, 2024)_  

These two values, being over the limit of validation, clearly indicate a problem with the initial version of the project.  
 
<MdImage src={images.bachelorproject_Picture68_png} alt="" class="w-full"/>_68 - Screen capture of the Android Galaxy A50 measurements for the NaïveShell scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture69_png} alt="" class="w-full"/>_69 - Measurements of the HLSL Shader project. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture70_png} alt="" class="w-full"/>_70 - Unity editor capture showing the measurement of the HLSLGeom scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture71_png} alt="" class="w-full"/>_71 - Unity editor capture showing the Memory Profiler on the HLSLGeom scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture72_png} alt="" class="w-full"/>_72 - Screen capture of the Android Galaxy A50 measurements for the HLSLGeom scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture73_png} alt="" class="w-full"/>_73 - Unity editor capture showing the measurement of the HLSLGeom1 scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture74_png} alt="" class="w-full"/>_74 - Measurement comparison on the HLSL Shader project with and without light_  
...
<MdImage src={images.bachelorproject_Picture75_png} alt="" class="w-full"/>_75 - Screen capture of the Android Galaxy A50 measurements for the HLSLGeom1 scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture76_png} alt="" class="w-full"/>_76 - Unity editor capture showing the measurement of the HLSL_ComplexeScene scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture77_png} alt="" class="w-full"/>_77 - Measurement of the HLSL Shader in the complex scene project. (Styles, 2024)_  

The vertex multiplication factor at 4.47, is a better result than in the HLSL single sphere scene (Figure 77, middle).   
 
<MdImage src={images.bachelorproject_Picture78_png} alt="" class="w-full"/>_78 - Capture of RenderDoc usage on the HLSL_ComplexeScene scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture79_png} alt="" class="w-full"/>_79 - Unity editor capture showing the Memory Profiler on the HLSL_ComplexeScene scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture80_png} alt="" class="w-full"/>_80 - Screen capture of the Android Galaxy A50 measurements for the HLSL_ComplexeScene scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture81_png} alt="" class="w-full"/>_81 - Measurements of the HLSL Complex object scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture82_png} alt="" class="w-full"/>_82 - Unity editor capture showing the measurement of the HLSL_ComplexeObject scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture83_png} alt="" class="w-full"/>_83 - Unity editor capture showing the Memory Profiler on the HLSL_ComplexeObject scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture84_png} alt="" class="w-full"/>_84 - Screen capture of the Android Galaxy A50 measurements for the HLSL_ComplexeObject scene. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture85_png} alt="" class="w-full"/>_85 - Measurements of the GPU frame time and comparison on all projects. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture86_png} alt="" class="w-full"/>_86 - Measurements of the multiplication factor and comparison on all projects. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture87_png} alt="" class="w-full"/>_87 - Measurements of the graphical memory allocation and comparison on all projects. (Styles, 2024)_  
...
<MdImage src={images.bachelorproject_Picture88_png} alt="" class="w-full"/>_88 - Measurements of the frames per second and comparison on all projects. (Styles, 2024)_  
...
Figures are ommitted in this web format.

## 10. Appendices
### Appendix A: Interview of David Sena

<MdImage src={images.bachelorproject_Picture89_png} alt="" class="w-full"/> 
 
### Appendix B: Interview of ChatGPT

<MdImage src={images.bachelorproject_Picture90_png} alt="" class="w-full"/>
<MdImage src={images.bachelorproject_Picture91_png} alt="" class="w-full"/>
<MdImage src={images.bachelorproject_Picture92_png} alt="" class="w-full"/>
