...
<Image src={images.rollback_BasicProject_png} alt="Basic Project" class="w-full"/>
...
<Image src={images.rollback_Loading_png} alt="Folder hierarchy" class="w-full"/> 
...
<Image src={images.rollback_Gameplay_gif} alt="Gameplay" class="w-full"/> 
