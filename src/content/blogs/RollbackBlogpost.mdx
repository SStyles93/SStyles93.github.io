...
description: "Creation of an animation system in multiplayer game with ECS and rollback."
order: 0
heroImage: "/src/assets/blogs/rollback/Gameplay.gif"
creationDate: "Nov 01 2022"
teamSize: 1
timeFrame: "3 months"
toolUsed: "C++/SFML"
---
...
<MdImage src={images.rollback_BasicProject_png} alt="Basic Project" class="w-full"/>
...
<MdImage src={images.rollback_Loading_png} alt="Folder hierarchy" class="w-full"/> 
...
<MdImage src={images.rollback_Gameplay_gif} alt="Gameplay" class="w-full"/> 
...
You can checkout the project from my Github repository
<div class="flex justify-center">
<Button href="https://github.com/SStyles93/SAE921-GPR5100-Network">GitHub</Button>
</div>
