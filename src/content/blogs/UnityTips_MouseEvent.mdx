...
The list of **interfaces** related to **Mouse Events** can be found [here](https://docs.unity3d.com/2019.1/Documentation/ScriptReference/EventSystems.IBeginDragHandler.html)
