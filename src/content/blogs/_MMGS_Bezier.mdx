...
<MdImage src={images.marblemaze_currency_gif} alt="Coin and star icons arcing to their HUD counters" class="w-full"/>

<div class="flex justify-center my-5">
  <Button href="/blog/marblemaze-save-system">Next: Save System & Data Persistence →</Button>
</div>
