...
<Image src={images.tool_PodRacerRef_png} alt="Pod racer reference" class="w-full"/>
...
<Image src={images.tool_PodPawn_png} alt="PodPawn game object" class="w-full"/>
...
<Image src={images.tool_Components_png} alt="Pod racer components" class="w-full"/>
...
```
<Image src={images.tool_DynamicRotations_png} alt="Pod racer dynamic rotations" class="w-full"/> 
...
<Image src={images.tool_CameraValues_png} alt="Pod racer camera values" class="w-full"/> 
...
<Image src={images.tool_Result_png} alt="Detail Window" class="w-full"/> 
