...
<Image src={images.opengl_lastScene_png} alt="LastScene" class="w-full"/> 
...
<Image src={images.opengl_SceneFlow_png} alt="SceneFlow" class="w-full"/> 
...
<Image src={images.opengl_ShadowMap_png} alt="ShadowMap" class="w-full"/> 
...
<Image src={images.opengl_separateARM_png} alt="separateARM" class="w-full"/>
...
SSAO | SSAO Blur
:-----:|:-----:
<Image src={images.opengl_SSAO_png} alt="SSAO" class="w-full"/>  | <Image src={images.opengl_SSAO1_png} alt="SSAO1" class="w-full"/>  
...
Downsample | Upsample
:-----:|:-----:
<Image src={images.opengl_downsampling_png} alt="downsample" class="w-full"/>  | <Image src={images.opengl_upsampling_png} alt="upsample" class="w-full"/>
...
<Image src={images.opengl_scene1_png} alt="LastScene" class="w-full"/> 
