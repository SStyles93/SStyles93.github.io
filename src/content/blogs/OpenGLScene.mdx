...
description: "Overview and explanation of my hand made graphic engine coded in C++ and OpenGL.
...
heroImage: "/src/assets/blogs/opengl/lastScene.png"
order: 0
...
<MdImage src={images.opengl_SceneFlow_png} alt="SceneFlow" class="w-full"/> 
...
<MdImage src={images.opengl_ShadowMap_png} alt="ShadowMap" class="w-full"/> 
...
<MdImage src={images.opengl_separateARM_png} alt="separateARM" class="w-full"/>
...
![combinedARM](/src/assets/blogs/opengl/combinedARM.png =25x)
...
SSAO | SSAO Blur
:-----:|:-----:
<MdImage src={images.opengl_SSAO_png} alt="SSAO" class="w-full"/>  | <MdImage src={images.opengl_SSAO1_png} alt="SSAO1" class="w-full"/>  
...
Downsample | Upsample
:-----:|:-----:
<MdImage src={images.opengl_downsampling_png} alt="downsample" class="w-full"/>  | <MdImage src={images.opengl_upsampling_png} alt="upsample" class="w-full"/>
...
<MdImage src={images.opengl_scene1_png} alt="LastScene" class="w-full"/> 
